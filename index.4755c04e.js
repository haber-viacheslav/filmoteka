 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const C="9.15.0";function I(e,t={}){let n=e;if("object"!=typeof t){t={name:t}}const r=Object.assign({name:h,automaticDataCollectionEnabled:!1},t),o=r.name;if("string"!=typeof o||!o)throw w.create("bad-app-name",{appName:String(o)});if(n||(n=(0,s.getDefaultAppConfig)()),!n)throw w.create("no-options");const a=p.get(o);if(a){if((0,s.deepEqual)(n,a.options)&&(0,s.deepEqual)(r,a.config))return a;throw w.create("duplicate-app",{appName:o})}const l=new(0,i.ComponentContainer)(o);for(const e of m.values())l.addComponent(e);const c=new b(n,r,l);return p.set(o,c),c}function E(e=h){const t=p.get(e);if(!t&&e===h)return I();if(!t)throw w.create("no-app",{appName:e});return t}function x(e,t,n){var r;let o=null!==(r=f[e])&&void 0!==r?r:e;n&&(o+=`-${n}`);const s=o.match(/\s|\//),a=t.match(/\s|\//);if(s||a){const e=[`Unable to register library "${o}" with version "${t}":`];return s&&e.push(`library name "${o}" contains illegal characters (whitespace or "/")`),s&&a&&e.push("and"),a&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void d.warn(e.join(" "))}y(new(0,i.Component)(`${o}-version`,(()=>({library:o,version:t})),"VERSION"))}
/**
 * @license
 ...
 * limitations under the License.
 */
const T="firebase-heartbeat-store";let S=null;function k(){return S||(S=(0,a.openDB)("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(T)}}).catch((e=>{throw w.create("idb-open",{originalErrorMessage:e.message})}))),S}async function N(e,t){try{const n=(await k()).transaction(T,"readwrite"),i=n.objectStore(T);return await i.put(t,O(e)),n.done}catch(e){if(e instanceof s.FirebaseError)d.warn(e.message);else{const t=w.create("idb-set",{originalErrorMessage:null==e?void 0:e.message});d.warn(t.message)}}}function O(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yn=new class{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}};class _n{getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const t=null!=this.optCompleteServerCache_?new Dt(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return fn(this.writes_,e,t)}}getChildAfterChild(e,t,n){const i=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:qt(this.viewCache_),r=hn(this.writes_,i,t,1,n,e);return 0===r.length?null:r[0]}constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vn(e,t,n,i,r){const o=new gn;let a,l;if(n.type===St.OVERWRITE){const c=n;c.source.fromUser?a=Cn(e,t,c.path,c.snap,i,r,o):((0,s.assert)(c.source.fromServer,"Unknown source."),l=c.source.tagged||t.serverCache.isFiltered()&&!Ie(c.path),a=bn(e,t,c.path,c.snap,i,r,l,o))}else if(n.type===St.MERGE){const c=n;c.source.fromUser?a=function(e,t,n,i,r,o,s){let a=t;return i.foreach(((i,l)=>{const c=Ce(n,i);In(t,ge(c))&&(a=Cn(e,a,c,l,r,o,s))})),i.foreach(((i,l)=>{const c=Ce(n,i);In(t,ge(c))||(a=Cn(e,a,c,l,r,o,s))})),a}(e,t,c.path,c.children,i,r,o):((0,s.assert)(c.source.fromServer,"Unknown source."),l=c.source.tagged||t.serverCache.isFiltered(),a=xn(e,t,c.path,c.children,i,r,l,o))}else if(n.type===St.ACK_USER_WRITE){const l=n;a=l.revert?function(e,t,n,i,r,o){let a;if(null!=dn(i,n))return t;{const l=new _n(i,t,r),c=t.eventCache.getNode();let u;if(Ie(n)||".priority"===ge(n)){let n;if(t.serverCache.isFullyInitialized())n=ln(i,qt(t));else{const e=t.serverCache.getNode();(0,s.assert)(e instanceof ot,"serverChildren would be complete if leaf node"),n=cn(i,e)}u=e.filter.updateFullNode(c,n,o)}else{const r=ge(n);let s=fn(i,r,t.serverCache);null==s&&t.serverCache.isCompleteForChild(r)&&(s=c.getImmediateChild(r)),u=null!=s?e.filter.updateChild(c,r,s,_e(n),l,o):t.eventCache.getNode().hasChild(r)?e.filter.updateChild(c,r,ot.EMPTY_NODE,_e(n),l,o):c,u.isEmpty()&&t.serverCache.isFullyInitialized()&&(a=ln(i,qt(t)),a.isLeafNode()&&(u=e.filter.updateFullNode(u,a,o)))}return a=t.serverCache.isFullyInitialized()||null!=dn(i,me()),Ut(t,u,a,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
