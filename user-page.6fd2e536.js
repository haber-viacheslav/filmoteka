 ...
 * limitations under the License.
 */
class ai extends Ln{extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const n=this.extractChild(e.node),i=this.extractChild(t.node),r=n.compareTo(i);return 0===r?Pt(e.name,t.name):r}makePost(e,t){const n=oi(e),i=ri.EMPTY_NODE.updateChild(this.indexPath_,n);return new An(t,i)}maxPost(){const e=ri.EMPTY_NODE.updateChild(this.indexPath_,si);return new An(Rt,e)}toString(){return wn(this.indexPath_,0).join("/")}constructor(e){super(),this.indexPath_=e,E(!En(e)&&".priority"!==gn(e),"Can't create PathIndex with empty path or .priority key")}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bi(){return{value:null,children:new Map}}function Ci(e,t,n){if(En(t))e.value=n,e.children.clear();else if(null!==e.value)e.value=e.value.updateChild(t,n);else{const i=gn(t);e.children.has(i)||e.children.set(i,bi());Ci(e.children.get(i),t=yn(t),n)}}function Ei(e,t,n){null!==e.value?n(t,e.value):function(e,t){e.children.forEach(((e,n)=>{t(n,e)}))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _r(e,t,n,i,r){const s=new pr;let o,a;if(n.type===Ii.OVERWRITE){const l=n;l.source.fromUser?o=wr(e,t,l.path,l.snap,i,r,s):(E(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered()&&!En(l.path),o=vr(e,t,l.path,l.snap,i,r,a,s))}else if(n.type===Ii.MERGE){const l=n;l.source.fromUser?o=function(e,t,n,i,r,s,o){let a=t;return i.foreach(((i,l)=>{const c=Cn(n,i);br(t,gn(c))&&(a=wr(e,a,c,l,r,s,o))})),i.foreach(((i,l)=>{const c=Cn(n,i);br(t,gn(c))||(a=wr(e,a,c,l,r,s,o))})),a}(e,t,l.path,l.children,i,r,s):(E(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered(),o=Er(e,t,l.path,l.children,i,r,a,s))}else if(n.type===Ii.ACK_USER_WRITE){const a=n;o=a.revert?function(e,t,n,i,r,s){let o;if(null!=cr(i,n))return t;{const a=new gr(i,t,r),l=t.eventCache.getNode();let c;if(En(n)||".priority"===gn(n)){let n;if(t.serverCache.isFullyInitialized())n=or(i,qi(t));else{const e=t.serverCache.getNode();E(e instanceof ri,"serverChildren would be complete if leaf node"),n=ar(i,e)}c=e.filter.updateFullNode(l,n,s)}else{const r=gn(n);let h=ur(i,r,t.serverCache);null==h&&t.serverCache.isCompleteForChild(r)&&(h=l.getImmediateChild(r)),c=null!=h?e.filter.updateChild(l,r,h,yn(n),a,s):t.eventCache.getNode().hasChild(r)?e.filter.updateChild(l,r,ri.EMPTY_NODE,yn(n),a,s):l,c.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=or(i,qi(t)),o.isLeafNode()&&(c=e.filter.updateFullNode(c,o,s)))}return o=t.serverCache.isFullyInitialized()||null!=cr(i,mn()),Fi(t,c,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class As{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Ls(e,t){let n=null;for(let i=0;i<t.length;i++){const r=t[i],s=r.getPath();null===n||kn(s,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(r)}n&&e.eventLists_.push(n)}function Ds(e,t,n){Ls(e,n),Fs(e,(e=>kn(e,t)))}function Ms(e,t,n){Ls(e,n),Fs(e,(e=>In(e,t)||In(t,e)))}function Fs(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const r=e.eventLists_[i];if(r){t(r.path)?(Bs(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function Bs(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();wt&&Et("event: "+n.toString()),qt(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
